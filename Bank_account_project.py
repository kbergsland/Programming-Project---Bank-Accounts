...
class BankAccount:
    ...
    def deposit(self, current_time):
        ...
        if self.deposited_amount > 0:
            ...
            print(f"You deposited {self.deposited_amount:.2f}$ at {current_time}. Your balance is now {self.balance:.2f}$.")
        else:
    ...
    def withdraw(self, current_time):
        try:
            self.withdrawn_amount = float(input("Please enter your desired withdrawal amount: "))
        except ValueError:
            print("Invalid input. Please enter a number.")
            return
        if self.withdrawn_amount <= self.balance:
            ...
            print(f"You withdrew {self.withdrawn_amount:.2f}$ at {current_time}. Your balance is now {self.balance:.2f}$.")
        else:
    ...
    def show_transaction_history(self):
        if not self.transaction_history:
            ...
            for record in self.transaction_history:
                print(f"{record['time']} - {record['type']}: {record['amount']}$")
